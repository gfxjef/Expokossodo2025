...
class AttendanceWebhookTester:
    ...
    def generate_test_data(self, count: int = 5) -> List[Dict[str, str]]:
        ...
        # Real employee data that worked successfully
        nombres = [
            "ELIANA JOGANY DIAZ MEGO", "Stephanie Lovon", "María José Fernández",
        ...
        empresas = [
            "GRUPOGRAT S.A.C", "Bioservice SRL", "Consultoría Empresarial Pro",
        ...
        cargos = [
            "Responsable laboratorio", "Analista de Sistemas", "Gerente de Proyectos",
        ...
        # Real photo URLs that worked successfully
        photo_urls = [
            "https://www.kossomet.com/public_html/clientexpokossodo/Eliana_Jogany_Diaz_Mego.jpg",
            "https://www.kossomet.com/public_html/clientexpokossodo/Stephanie_Lovon.jpg",
    ...
    def test_health_endpoint(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"[OK] Health check passed: {health_data.get('status', 'Unknown')}")
                return True
            else:
    ...
    def run_test_suite(self, count: int = 5, delay: float = 2.0) -> Dict[str, Any]:
        ...
        """
        print(f"\n[ROCKET] Starting Attendance Webhook Test Suite")
        print(f"[TARGET] Target URL: {self.webhook_url}")
        print(f"[COUNT] Test count: {count}")
        print(f"[TIME] Delay between tests: {delay}s")
        print("-" * 60)
